...
def get_interactive_elements(xml_content: str) -> List[Dict]:
    ...
    try:
        ...
        print("Error parsing XML. The screen might be loading.")
        return []
    ...
    for node in root.iter():
        ...
        is_editable = (
            ...
            or node.attrib.get("focus") == "true"
            or "EditText" in node.attrib.get("class", "")
        )
        ...
        if bounds:
            try:
                ...
                element = {
                    ...
                    "action": (
                        "tap" if is_clickable else ("type" if is_editable else "read")
                    ),
                }
